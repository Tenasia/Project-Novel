...
# define gui.hover_color = u'#5f5f5f'

# ## The color used for a text button when it is selected but not focused. A
# ## button is selected if it is the current screen or preference value.
# define gui.selected_color = u'#000'
...
# define gui.name_text_font = "fonts/Poppins-Light.ttf"
...
# ## center.
# define gui.dialogue_xpos = 0.125
...
#     # style.window.yminimum = 260



#     # def message_background_displayable(st, at):
#     #     return At(Frame("gui/textbox.png", 0, 60, 0, 0, tile=True), alpha(persistent.window_opacity)), None
#     # style.window.background = DynamicDisplayable(message_background_displayable)

#     # style.window.yminimum = 260
#     style.say_window.margin = (0, 0)
...
#     # style.window.bottom_padding = 45
...
#     style.say_who_window.background = Frame("gui/var_bar.png", 36, 0, yoffset = 0,xoffset= 681, ysize = 50, xsize = 598)
#     style.say_who_window.margin = (0, 0)
#     style.say_who_window.xalign = 0.5
#     style.say_who_window.xminimum = 280
#     style.say_who_window.ysize = 45
