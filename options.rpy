...
define config.name = _("Bellum Perpetuum v3")
...
define build.name = "BellumPerpetuumv3"
...
define config.intra_transition = ImageDissolve("images/transitions/19.jpg", 1.0, 8)
